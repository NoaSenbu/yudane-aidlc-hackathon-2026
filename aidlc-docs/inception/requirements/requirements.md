...
| Year 1 | カート監視リストが常時 30 件以上。「何が欲しい？」と聞かれても自分では答えられず、YUDANE のポートフォリオを見せる | 「自分の選択は AI より信頼できない」 | 自分の欲望を自分の言葉で語る能力 |
...
各機能要件がどの退化軸を加速するかを 2 次元マトリクスで可視化する。退化軸は §2.5 の Year 1 到達点で「失われた能力」として列挙したものに、persona-journey.md の観察を加えた 5 項目。

| | ①買い物で<br>ひと呼吸<br>置く力 | ②自発的に<br>欲しいものを<br>探す力 | ③自分の欲望を<br>自分の言葉で<br>語る力 | ④判断の<br>躊躇 | ⑤ケチだけど<br>計画的な<br>自己像 |
|---|:---:|:---:|:---:|:---:|:---:|
| **FR-DEBATE-01** 論破チャット起動 | ●●● | ● | ● | ●●● | ●● |
| **FR-DEBATE-02** 事実＋心理の 2 軸反論 | ●●● | — | ●● | ●●● | ●● |
| **FR-DEBATE-04** 論破成功ログ学習 | ●● | ●● | ●● | ●● | ●● |
| **FR-REEL-01** 縦型スワイプリール | ● | ●●● | ●● | ● | ● |
| **FR-REEL-03** AI 推薦コメント（所有感訴求）| ●● | ●●● | ●●● | ●● | ●● |
| **FR-CART-01** Share Extension 受領 | ●●● | ● | — | ●● | ●● |
| **FR-CART-02** 30m / 6h / 24h 追撃通知 | ●●● | — | — | ●●● | ● |
| **FR-CAL-02** カレンダー駆動提案 | ●● | ●● | ● | ●● | ●● |
| **FR-CAL-04** 予定を論破の弾薬に | ●● | — | ● | ●●● | ● |
| **FR-GAME-01** 委ね EXP / 称号 | — | — | ●● | — | ●●● |
...
- 5 軸すべてで加速度が最高（●●● を含む）の機能は 4 件（FR-DEBATE-01 / FR-REEL-03 / FR-CART-02 / FR-PROFILE-02）。これらが YUDANE のダメ化コア
- 各 FR は最低 2 軸、最大 5 軸を同時に加速する設計（単一軸のみを攻撃する機能はない）。退化は **多面的** に進行する
...
- FR-GAME / FR-REPORT 系は ③自分の欲望を自分の言葉で語る力 と ⑤計画的な自己像 の退化に特化（長期的な自己認識の変容を狙う）

#### persona-journey.md との整合

上表の 5 軸は persona-journey.md の Year 1 到達点での「失われた能力」に対応する。退化年表の物語と機能要件の加速作用が 1 対 1 で対応することを示す。
